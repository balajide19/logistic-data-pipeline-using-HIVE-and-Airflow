...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    cluster_name='logisticproject1',
    region='us-central1',
    project_id='helical-glass-399805',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistic-raw-data/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistic-raw-data/input_data/logistics_*.csv gs://logistic-archival/",
    dag=dag
)
